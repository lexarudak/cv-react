...
import { LANG_COMPONENTS } from 'components/Summary/const';
...
export const ProjectPage = (): JSX.Element => {
  ...
  const { title, techStack, photo, bgPosition, id, repo, deploy, task } = project;
  const LINK_LIST = [
    [repo, 'repo'],
    [deploy, 'deploy'],
    [task, 'task'],
  ...
  return (
    <section className={styles.container}>
      ...
      <a
        ...
        style={{ backgroundImage: photo, backgroundPosition: bgPosition }}
        rel="noreferrer"
      >
