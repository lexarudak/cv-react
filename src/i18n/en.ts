export const en = {
  ...
  project: {
    ...
    task: 'Task',
    description: {
      '2': 'Command task. Playground for graphql queries. The application is written in Next.js 13 using app router. I am most pleased with how we managed to create a beautiful, monolithic application not only for desktop, but also for mobile use on a new framework for us\n\n<dark>Participation in the project:</dark>\nTim leader\nWelcome page (partial)\nResponsive design\nGraphQL Queries\nResponse processing\nError processing\nPlayground page design\nLocalization (partially)',
      ...
      '4': 'Application for the distribution of your time. Done as part of a team. A detailed description and navigation of the application can be found <routine>here</routine>. The application is written without the use of libraries and frameworks. The most difficult and interesting part is the timeline, which is written in pure TS\n\n<dark>Participation in the project:</dark>\nTeam leader\nApplication idea\nApp design\nPage of the week\nPage of the day\nRegistration page\nPlan creating popup',
